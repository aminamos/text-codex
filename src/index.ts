...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/" || url.pathname === "/index.html") return new Response(INDEX_HTML + '<script src="/client.js"></script>', { headers: htmlHeaders });
